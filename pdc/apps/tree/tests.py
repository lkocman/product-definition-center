...
class TreeAPITestCase(APITestCase):
    def test_create_unreleasedvariant(self):
        ...
        data = {
            ...
            'variant_name': "Core", 'variant_version': "0-1",
            'variant_type': 'module', 'koji_tag': "module-core-0-1"
        }
    ...
    def test_create_tree(self):
        ...
        data = {
            ...
            'variant_name': "Shells", 'variant_version': "0-1",
            'variant_type': 'module', 'koji_tag': "module-shells-0-1"}
        response = self.client.post(url, data, format='json')
        self.assertEqual(response.status_code, status.HTTP_201_CREATED)
        ...
        data = {
            ...
            'variant': {"variant_uid": "Shells", "variant_version": "0-1"},
